...
ap_methods_section <- function(res, run_dir = NULL, provenance_dir = NULL) {
  ...
  if (!is.null(res$screen)) {
    add(sprintf(paste0("An exploratory screen tested every usable metadata variable against ",
                       ...
                       "unadjusted R2 increases with the number of levels a variable has, and ",
                       "alpha and beta tests were ranked separately because their effect sizes ",
                       "are proportions of different variances. A ",
